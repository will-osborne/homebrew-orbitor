class Orbitor < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "ceab22a78deb2e4d7288a450084079a27900fd3ea6a941b4f1d4ffde5ff8e566"
    end
    on_intel do
      url "https://github.com/will-osborne/orbitor/releases/download/v#{version}/orbitor-darwin-amd64"
      sha256 "9e9388053964cf3d92e8c1adef706c5845dab2a98a2a7ecf6ea3eea834c6ef2e"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "2b0856418d9444e44fcc96c9531baff8de39f32dc2969d678473fbb4e96c7168"
    end
    on_intel do
      url "https://github.com/will-osborne/orbitor/releases/download/v#{version}/orbitor-linux-amd64"
      sha256 "b6d247070eea8fea0b19144ada5d1e898dc4abd57dc77fec9aa0af813ce61829"
    end
  end
