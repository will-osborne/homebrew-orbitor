class Orbitor < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "5b90e60b0bae4e4a49296c5ed9fe6ec377f1311f7aacb077e2676fc2ad18c5ca"
    end
    on_intel do
      url "https://github.com/will-osborne/orbitor/releases/download/v#{version}/orbitor-darwin-amd64"
      sha256 "26a8c588c7592fbe808e442cc5bb43fe459203fd6d46529207ff23b6129cc712"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "c2f018c4d374e3f515bf81b7f450b3fbf5a12dcb5b7a468234b2353310b14952"
    end
    on_intel do
      url "https://github.com/will-osborne/orbitor/releases/download/v#{version}/orbitor-linux-amd64"
      sha256 "f97692f0e3370190ec0bc4e392650ec8b5b1ac5438b2070d78f6743a7fd553ac"
    end
  end
