class Orbitor < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "c46d345edc0b833bc023c4ad069869418cbde88eb73e1b7e00407d36ebd797ea"
    end
    on_intel do
      url "https://github.com/will-osborne/orbitor/releases/download/v#{version}/orbitor-darwin-amd64"
      sha256 "6b9ab579ccf486422454df9aa50849c36acc20f4fdf31c7f3d870ae648e9c034"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "9cf03d538598e38450e06b5abedb27be6e03f293fabca89b9b1cf0e160bbc4a8"
    end
    on_intel do
      url "https://github.com/will-osborne/orbitor/releases/download/v#{version}/orbitor-linux-amd64"
      sha256 "377b78a33807065bcaffaaa5223d0ff9d451fbf09f803d4ebd7c7183df9c8d6a"
    end
  end
